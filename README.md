...
8. [The Code (Powered by Django)](README_TheCode.md#the-code-powered-by-django)
   ...
   8. [Views](README_TheCode.md#views)
    ...
    16. [Delete Booking (delete_booking)](README_TheCode.md#delete-booking-delete_booking)
    17. [Approve/Reject Cancellation Request (approve_reject_cancellation_request)](README_TheCode.md#approvereject-cancellation-request-approve_reject_cancellation_request)
...
11. [Tests](README_Tests.md#Tests)
    ...
    25. [DeleteBookingViewTest - Testing the Delete Booking View](README_Tests.md#deletebookingviewtest---testing-the-delete-booking-view)
    26. [ApproveRejectCancellationRequestViewTest - Testing Cancellation Request Approvals and Rejections](README_Tests.md#approverejectcancellationrequestviewtest---testing-cancellation-request-approvals-and-rejections)
    27. [JarallaxTest - Testing Jarallax Initialization](README_Tests.md#jarallaxtest---testing-jarallax-initialization)
    28. [MessageAlertsTest - Testing Message Alerts](README_Tests.md#messagealertstest---testing-message-alerts)
    29. [AJAXFilterTests - Testing AJAX-Based Filtering](README_Tests.md#ajaxfiltertests---testing-ajax-based-filtering)
    30. [MapTest - Testing Map Display](README_Tests.md#maptest---testing-map-display)
    31. [Webpage loading test - Test webpage loads with jarallax](README_Tests.md#webpage-loading-test---test-webpage-loads-with-jarallax)
    32. [Submit form and Display Message Test - Test forms and message display](README_Tests.md#submit-form-and-display-message-test---test-forms-and-message-display)
